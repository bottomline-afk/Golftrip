...
const grandDunesHoles: CourseHole[] = [
  { number: 1, par: 4, strokeIndex: 10, yardage: 396 },
  { number: 2, par: 3, strokeIndex: 16, yardage: 137 },
  { number: 3, par: 4, strokeIndex: 6, yardage: 378 },
  { number: 4, par: 5, strokeIndex: 4, yardage: 506 },
  { number: 5, par: 4, strokeIndex: 14, yardage: 383 },
  { number: 6, par: 4, strokeIndex: 18, yardage: 305 },
  { number: 7, par: 5, strokeIndex: 12, yardage: 495 },
  { number: 8, par: 3, strokeIndex: 8, yardage: 155 },
  { number: 9, par: 4, strokeIndex: 2, yardage: 386 },
  { number: 10, par: 4, strokeIndex: 13, yardage: 385 },
  { number: 11, par: 3, strokeIndex: 17, yardage: 124 },
  { number: 12, par: 4, strokeIndex: 15, yardage: 350 },
  { number: 13, par: 5, strokeIndex: 1, yardage: 499 },
  { number: 14, par: 3, strokeIndex: 5, yardage: 158 },
  { number: 15, par: 4, strokeIndex: 7, yardage: 400 },
  { number: 16, par: 4, strokeIndex: 3, yardage: 365 },
  { number: 17, par: 5, strokeIndex: 11, yardage: 477 },
  { number: 18, par: 4, strokeIndex: 9, yardage: 373 },
];

const dunesClubHoles: CourseHole[] = [
  { number: 1, par: 4, strokeIndex: 4, yardage: 385 },
  { number: 2, par: 4, strokeIndex: 12, yardage: 370 },
  { number: 3, par: 4, strokeIndex: 8, yardage: 390 },
  { number: 4, par: 5, strokeIndex: 2, yardage: 430 },
  { number: 5, par: 3, strokeIndex: 18, yardage: 165 },
  { number: 6, par: 4, strokeIndex: 10, yardage: 370 },
  { number: 7, par: 4, strokeIndex: 16, yardage: 370 },
  { number: 8, par: 5, strokeIndex: 6, yardage: 470 },
  { number: 9, par: 3, strokeIndex: 14, yardage: 140 },
  { number: 10, par: 4, strokeIndex: 11, yardage: 325 },
  { number: 11, par: 4, strokeIndex: 3, yardage: 370 },
  { number: 12, par: 3, strokeIndex: 13, yardage: 150 },
  { number: 13, par: 5, strokeIndex: 1, yardage: 520 },
  { number: 14, par: 4, strokeIndex: 5, yardage: 388 },
  { number: 15, par: 5, strokeIndex: 9, yardage: 475 },
  { number: 16, par: 4, strokeIndex: 17, yardage: 330 },
  { number: 17, par: 3, strokeIndex: 15, yardage: 155 },
  { number: 18, par: 4, strokeIndex: 7, yardage: 365 },
];

const barefootFazioHoles: CourseHole[] = [
  { number: 1, par: 4, strokeIndex: 9, yardage: 323 },
  { number: 2, par: 4, strokeIndex: 1, yardage: 406 },
  { number: 3, par: 3, strokeIndex: 17, yardage: 122 },
  { number: 4, par: 5, strokeIndex: 7, yardage: 440 },
  { number: 5, par: 4, strokeIndex: 3, yardage: 441 },
  { number: 6, par: 3, strokeIndex: 13, yardage: 144 },
  { number: 7, par: 5, strokeIndex: 5, yardage: 494 },
  { number: 8, par: 3, strokeIndex: 15, yardage: 127 },
  { number: 9, par: 4, strokeIndex: 11, yardage: 332 },
  { number: 10, par: 5, strokeIndex: 4, yardage: 471 },
  { number: 11, par: 3, strokeIndex: 16, yardage: 154 },
  { number: 12, par: 5, strokeIndex: 6, yardage: 489 },
  { number: 13, par: 4, strokeIndex: 2, yardage: 345 },
  { number: 14, par: 4, strokeIndex: 10, yardage: 326 },
  { number: 15, par: 4, strokeIndex: 14, yardage: 282 },
  { number: 16, par: 3, strokeIndex: 18, yardage: 149 },
  { number: 17, par: 4, strokeIndex: 8, yardage: 328 },
  { number: 18, par: 4, strokeIndex: 12, yardage: 305 },
];
