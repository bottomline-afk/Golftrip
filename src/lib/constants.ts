...
export const DEFAULT_TRIP: Omit<Trip, 'id'> = {
  ...
  teams: {
    team1: { name: 'Neon Sharks', color: '#00ffff' },
    team2: { name: 'Pixel Wolves', color: '#ff00ff' },
  },
  players: {
    p1: { name: 'Mike', handicapIndex: 12.4, strokes: 13, teamId: 'team1', avatarUrl: '' },
    p2: { name: 'Dave', handicapIndex: 8.2, strokes: 9, teamId: 'team1', avatarUrl: '' },
    p3: { name: 'Chris', handicapIndex: 15.1, strokes: 16, teamId: 'team1', avatarUrl: '' },
    p4: { name: 'Jeff', handicapIndex: 20.3, strokes: 22, teamId: 'team1', avatarUrl: '' },
    p5: { name: 'Tom', handicapIndex: 10.7, strokes: 11, teamId: 'team2', avatarUrl: '' },
    p6: { name: 'Rick', handicapIndex: 6.0, strokes: 6, teamId: 'team2', avatarUrl: '' },
    p7: { name: 'Steve', handicapIndex: 18.5, strokes: 20, teamId: 'team2', avatarUrl: '' },
    p8: { name: 'Dan', handicapIndex: 14.0, strokes: 15, teamId: 'team2', avatarUrl: '' },
  },
  schedule: [
